...
import com.example.dispositivosmoviles.ui.ui.viewmodels.BiometricViewModel
...
//            autenticateBiometric()
            lifecycleScope.launch {
                biometricViewModel.chargerData()
            }
        }

        biometricViewModel.isLoading.observe(this){itLoading ->
            if(itLoading){
